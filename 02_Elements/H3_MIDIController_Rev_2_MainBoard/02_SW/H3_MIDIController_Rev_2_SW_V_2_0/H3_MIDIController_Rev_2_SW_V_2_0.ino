// Name: H3_HMI_TestBoard_Rev_2_SW_2_0
// Programmer: Pablo dMM (Pablodmm.isp@gmail.com)
// Date: July 2017
// Description:
// Test Code for H3_MIDIController_Rev_2 Board. Part of the Henar 3 project in which Autofabricantes collaborates.
...
int SW_LED[(SW_Q)][3] = {{OFF_R}};     // LED PAD RGB Color Values
...
void SW_PAD_read(){
  for (int i=0; i<SW_Q; i++){
    ...
    if (analogRead(MUX_OUT_0) < SW_THR){  // If SW Pad activated
...
void SW_LED_update(){
  for(int i=0; i<SW_Q; i++){ // PAD Button Iterator
